  ...
  <View className="flex-1 justify-center items-center bg-white px-4">
    <View className="w-full  px-6  pb-12 items-center">
      ...
      <View className="relative w-11/12 mb-8">
        ...
        <TextInput
          className={`w-full border rounded-2xl p-3.5 text-base text-gray-800 ${isEmailFocused ? 'border-blue-600' : 'border-gray-300'
            }`}
          value={email}
      ...
      <View className="relative w-11/12 mb-8">
        ...
        <TextInput
          className={`w-full border rounded-2xl p-3.5 text-base text-gray-800 ${isPasswordFocused ? 'border-blue-600' : 'border-gray-300'
            }`}
          value={password}
